...
function getKycContract(web3) {
  ...
  //     encoding: "utf-8",
  //   })
  // );//TODO: Instead of KYC.abi we will use abi file generate by truffle for now
  const abi = './build/contracts/KYC.json';
...
async function updateMyProfile(kycTest) {
  const _info = await kycTest.methods
    ...
    // .updateProfile("nitin", "nitinpatel@gmail.com", 9876543210)
    .send();
  console.log(_info);
}
